...
[繁體中文](https://github.com/HryGan404/hugo-theme-meme/blob/main/README.zh-tw.md)
...
1. Replace `hugo.toml` with [config examples](https://github.com/HryGan404/hugo-theme-meme/blob/main/config-examples/en/config.toml).
...
MemE uses SCSS via [Hugo Pipes](https://gohugo.io/hugo-pipes/introduction/) to generate CSS instead of static CSS file and provides a [`_custom.scss`](https://github.com/HryGan404/hugo-theme-meme/blob/main/assets/scss/custom/_custom.scss) for customization.
...
**Note that** MemE makes some brand new features or _breaking changes_ sometimes, so please be sure to check [the modification history of `config.toml`](https://github.com/HryGan404/hugo-theme-meme/commits/main/config-examples) and update the related items after the update!
