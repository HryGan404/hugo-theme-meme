...
1. 将 `hugo.toml` 替换为[示例配置](https://github.com/HryGan404/hugo-theme-meme/blob/main/config-examples/zh-cn/config.toml)。
...
MemE 通过 Hugo 管道实现使用 SCSS 生成 CSS，而非静态的 CSS 文件，同时提供一个 [`_custom.scss`](https://github.com/HryGan404/hugo-theme-meme/blob/main/assets/scss/custom/_custom.scss) 文件以供用户定制。
...
**特别注意**：MemE 主题有时会新增一些全新功能或一些毁灭改动，所以在你更新完后，请务必检查 [`config.toml` 的改动历史](https://github.com/HryGan404/hugo-theme-meme/commits/main/config-examples)并将相应内容也更新！
